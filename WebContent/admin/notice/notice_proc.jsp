<%@ page contentType="text/html;charset=EUC-KR"  errorPage="notice_error.jsp" import="myShop.notice.action.*,myShop.notice.db.*" %>
...
<jsp:useBean id="gb" class="myShop.notice.action.NoticeMgr"/>
